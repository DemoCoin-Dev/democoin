...
This document provides guidelines for internationalization of the Democoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `democoin_en.ts` remains unchanged.
