Democoin Core version 0.13.2 is now available from:
  ...
  <https://democoin.org/bin/democoin-core-0.13.2/>
...
- #8908 `4a974b2` Update democoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow democoin-tx to create v2 transactions (dmcdrak)
