Democoin Core version 0.16.1 is now available from:

  <https://democoincore.org/bin/democoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting democoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure democoind processes are cleaned up when tests end (sdaftuar)
