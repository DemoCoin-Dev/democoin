Democoin Core version 0.9.2.1 is now available from:

  https://democoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 DMC to 0.01 DMC
...
- Fix "Start democoin on system login"
