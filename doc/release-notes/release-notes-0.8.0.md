Democoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/democoin/files/Democoin/democoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Democoin
...
New/changed settings (command-line or democoin.conf file)
--------------------------------------------------------
