Democoin Core version 0.10.4 is now available from:

  <https://democoin.org/bin/democoin-core-0.10.4/>
...
- #6953 `43c2789` Split democoin-tx into its own package
- #6953 `dfe0d4d` Include democoin-tx binary on Debian/Ubuntu
