Democoin Core version 0.9.4 is now available from:

  https://democoin.org/bin/0.9.4/
...
this update is incompatible with the Democoin system and could lead to consensus
forks.

Democoin Core released binaries from https://democoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~democoin/+archive/ubuntu/democoin
- A third-party or self-compiled Democoin Core

upgrade to Democoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
