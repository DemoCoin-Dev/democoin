...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, DemocoinUnits::SeparatorStyle separators=DemocoinUnits::separatorStandard) const;
