    ...
    mapper(0)
{
    ...
    ui->democoinAtStartup->setToolTip(ui->democoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->democoinAtStartup->setText(ui->democoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openDemocoinConfButton->setToolTip(ui->openDemocoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new DemocoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->democoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openDemocoinConfButton_clicked()
{
