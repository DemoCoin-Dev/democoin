...
/** Democoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class DemocoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit DemocoinUnits(QObject *parent);

    /** Democoin units.
      @note Source: https://en.democoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        DMC,
...
typedef DemocoinUnits::Unit DemocoinUnit;
