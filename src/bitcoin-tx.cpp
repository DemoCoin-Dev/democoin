...
static void SetupDemocoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " democoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  democoin-tx [options] <hex-tx> [commands]  Update hex-encoded democoin transaction\n" +
            "or:     democoin-tx [options] -create [commands]   Create hex-encoded democoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded democoin transaction
