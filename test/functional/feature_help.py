...
"""Verify that starting democoin with -h works as expected."""

from test_framework.test_framework import DemocoinTestFramework
from test_framework.util import assert_equal

class HelpTest(DemocoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start democoin with -h for help text")
        ...
        self.log.info("Start democoin with -version for version information")
        ...
        self.log.info("Start democoind with -fakearg to make sure it does not start")
