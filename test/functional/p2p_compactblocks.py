...
# TestP2PConn: A peer we use to send messages to democoind, and store responses.
...
class CompactBlocksTest(DemocoinTestFramework):
    ...
    # This test actually causes democoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that democoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for democoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # democoind will not send blocktxn responses for blocks whose height is
