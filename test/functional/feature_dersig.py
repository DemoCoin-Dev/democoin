...
class BIP66Test(DemocoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # democoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and democoind produces more specific reject
            # reasons.
